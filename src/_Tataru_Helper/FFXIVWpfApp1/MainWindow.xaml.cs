...
namespace FFXIVTataruHelper
{
    ...
    public partial class MainWindow : Window //-V3072
    {
        ...
        private readonly NodeServer nodeServer = new NodeServer();
        ...
        private async void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                /////////////////////////////////////////////////// Tataru Helper Node
                _TataruModel.ChatProcessor.TextArrived += TextArrivedForNode;
        ...
        // post
        private void PostToNodeServer(string dataString)
        {
            // url
            string url = "http://" + nodeServer.IP + ":" + nodeServer.Port;

            // post
            try
            {
                client.PostAsync(url, new StringContent(dataString, Encoding.UTF8, "application/json"));
            }
            catch (Exception ex)
            {
                Logger.WriteLog(ex);
