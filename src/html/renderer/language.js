...

{
  ...
  const elementTextList = {
    ...
    label: {
      ...
      'color-background-color': ['背景顏色', '背景颜色', 'Color'],
      'range-background-transparency': ['背景透明度', '背景透明度', 'Transparency'],
      ...
      'color-dialog-color': ['對話框顏色', '对话框颜色', 'Color'],
      'range-dialog-transparency': ['對話框透明度', '对话框透明度', 'Transparency'],
