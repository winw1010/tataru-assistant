...
// ASMSignature: CODE BYTES NEAR TARGET BASE ADDRESS (CHECK Executable WHEN SEARCHING ASMSignature)
// ASMSignature path[0,0]: TARGET BASE ADDRESS (Value in ["ffxiv_dx11.exe"+XXXXXXXX])
