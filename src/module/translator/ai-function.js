...
function createPrompt(source = 'Japanese', target = 'Chinese', table = [], type = 'sentence', defaultPrompt = '') {
  ...
  let prompt = defaultPrompt? defaultPrompt : `Translate the following ${type} from ${source} to ${target}. Translation only.`;
